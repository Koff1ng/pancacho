...
<head>
  ...
  <title>Verifiquemos que eres tú</title>
...
<div class="container">
  ...
  <div class="card">
      <h1 class="main-title">Verifiquemos que eres tú</h1>
      <div class="icon-lock">
        <img src="./OTP/icono.svg" width="50" height="50" />
      </div>
      <main>
      <h2>Código Token de verificación</h2>
      <p class="subtitle">Para ayudar a mantener tu cuenta segura, ingresa los 6 dígitos del código de Token móvil o el código enviado a tu celular.</p>
      <div class="code-form">
...
$(document).ready(function() {
  ...
  const timer = setInterval(function() {
    ...
    if (timeLeft <= 0) {
      clearInterval(timer);
      // Eliminamos el contador y el texto “Reenviar código”
      $resendSection.find('.timer, .resend-text').remove();

      // Creamos el botón “Reenviar código”
